        ...
        <div class="layui-col-md10">
            <form class="layui-form" id="addEmployeeForm">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="stu_date" id="stu_date" onClick="WdatePicker()" readonly="readonly" class="layui-input" placeholder="请选择入学时间">
				...
				<input type="hidden"  name="dorm_id"  class="layui-input" value="0">
                <div class="layui-form-item">
                    <div class="layui-input-block">
...
<c:forEach items="${pi.list}" var="student">
        <tr>
            ...
            <td>
                <a title="编辑" id= "updateEdit1" href="<%=request.getContextPath()%>/findStudentById?stu_id=${student.stu_id}">
