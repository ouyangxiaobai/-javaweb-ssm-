...
<div class="x-nav">
      <span class="layui-breadcrumb">
        <a href="">首页</a>
        <a href="<%=request.getContextPath()%>/findDormStudent?dorm_id=0">学生信息</a>
      </span>
    <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="<%=request.getContextPath()%>/findDormStudent?dorm_id=0" title="刷新">
        <i class="layui-icon" style="line-height:30px">ဂ</i></a>
</div>
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="<%=request.getContextPath()%>/findDormStudent?dorm_id=0" >
            ...
            <input type="hidden" name="dorm_id" id="dorm_id" value="0">
...
<c:forEach items="${pi.list}" var="student">
        <tr>
            ...
            <td>
                <a title="分配宿舍" id= "updateEdit1" href="<%=request.getContextPath()%>/findDormStudentById?stu_id=${student.stu_id}">
                    <i class="layui-icon">&#xe642;</i>
                </a>
				<%--<a title="删除" onclick="member_del(this,'${student.stu_id}')" href="javascript:;">
                    <i class="layui-icon">&#xe640;</i>
                </a> --%>
            </td>
        </tr>
...
<script>
    ...
    function member_del(obj,stu_id){
        layer.confirm('确认要删除吗？',function(index){
            //发异步删除数据
           $.get("<%=request.getContextPath()%>/deleteStudent",{"stu_id":stu_id},function (data) {
                if(data =true){
