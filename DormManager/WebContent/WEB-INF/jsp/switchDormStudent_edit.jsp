		...
		<div class="layui-form-item" >
            ...
            <div class="layui-input-inline">
                <input type="text" id="stu_num" name="stu_num"
                       autocomplete="off" value="${s.stu_num}" class="layui-input" disabled="disabled">
            </div>
        </div>
		...
		<div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="stu_name" name="stu_name"
                       autocomplete="off" value="${s.stu_name}" class="layui-input" disabled="disabled">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
            	<input type="text" id="stu_sex" name="stu_sex"
                       autocomplete="off" value="${s.stu_sex}" class="layui-input" disabled="disabled">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="stu_date" name="stu_date"
                       autocomplete="off" value="${s.stu_date}" class="layui-input" disabled="disabled">
            </div>
        </div>
     </div>
     <div style="float: left;">
    <%--把表单封装成一个Student对象传给服务端--%>
    <form class="layui-form"  id="f_auto" action="<%=request.getContextPath()%>/updateSwitchDormStudent" method="post" >
        <input type="hidden" value="${s.stu_id}" name="stu_id" id="stu_id" class="layui-input"/>
        <input type="hidden" value="${s.dorm_id}" name="old_dorm_id" id="old_dorm_id" class="layui-input"/>
        <%-- <div class="layui-form-item">
...
<script>
    ...
    //
    //         $.ajax({
    //             url: '<%=request.getContextPath()%>/updateSwitchDormStudent',
    //             type: "post",
